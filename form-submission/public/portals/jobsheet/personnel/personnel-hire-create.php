...
<div class="container">
    ...
    <div id="profile" class="card card-def mb-5">
        ...
        <div class="card-body">
            ...
            <form class="col-12" action="personnel-hire-create.php" method="post">
                <div class="row">
                ...
                <div class="row mb-5">
                    <div class="col-3">
                        ...
                        <input type="text" class="form-control" name="personnel_type" id="type">
                    </div>
                    <div class="col-3">
                        <label for="hours">Hours: </label>
                        <input type="number" class="form-control" name="personnel_hrs" id="hours">
                    </div>
                    <div class="col-3">
                        <label for="day">Days: </label>
                        <input type="number" class="form-control" name="personnel_days" id="day">
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <button class="btn btn-primary btn-lg pl-5 pr-5" type="submit" name="add-personnel">Add</button>
