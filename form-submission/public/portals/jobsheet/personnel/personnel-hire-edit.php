...
<div class="container">
    <div class="col-12 aligner mb-3">
        ...
        <h1>Personnel Hire</h1>
    </div>

    <div id="profile" class="card card-def mb-5">
        <div class="card-header blue-bkgrd">
            <h2>Edit Personnel Hire List</h2>
        </div>
        <div class="card-body">
            <div class="col-12">
                <p>To add to, or edit existing personnel hire requirements for job sheet, insert details below.</p>
            </div>
