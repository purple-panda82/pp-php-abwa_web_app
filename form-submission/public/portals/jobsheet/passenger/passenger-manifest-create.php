...
<div class="container">
    ...
    <div id="profile" class="card card-def mb-5">
        <div class="card-header blue-bkgrd">
            <h2>Add Passenger Manifest</h2>
        </div>
        <div class="card-body">
            <div class="col-12">
                <p>The following form can be used to add all certification associated with your Crew Role</p>
            </div>
            <form class="col-12" action="passenger-manifest-create.php" method="post">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-6">
                        <button class="btn btn-primary btn-lg pl-5 pr-5" type="submit" name="add-passenger">Add</button>
