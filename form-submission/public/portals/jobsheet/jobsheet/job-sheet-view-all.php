...
<div class="container">
    ...
    <div id="profile" class="card card-def mb-5">
        <div class="card-header blue-bkgrd">
            <h2>View All Job Sheets</h2>
        </div>
        <div class="card-body">
            <div class="col-12">
                <p>The following list are all job sheets currently listed in the ABWA database</p>
            </div>
            <?php displayAllJobSheets(); ?>
        </div>
    </div>

    <footer class="col-12 mt-5">
        <a class='btn btn-primary blue-bkgrd' href='../../../portals/crew/profile/crew-view.php?id=<?php echo $crew_id ?>'><h2>Go Back</h2></a>
