...
<div class="container">
    ...
    <div id="profile" class="card card-def mb-5">
        ...
        <div class="card-body">
            <div class="col-12">
                <p>The following details relate to your time sheet associated with your profile. To edit, click the 'Edit' button.</p>
            </div>
            <!--<form class="col-12" action="../certified/crew-certs-create.php" method="post">
                <div class="row">
