...
<head>
    ...
    <title>View your Certifications</title>
...
<div class="container">
    <div class="col-12 aligner mb-3">
        ...
        <h1>View Crew Cards</h1>
        <p>The Following list are those certifications associated with your role within the ABWA Database</p>
    </div>
    ...
    <div id="profile" class="card card-def mb-5">
        ...
        <div class="card-body">
            <div class="col-12">
                <p>Please input your details into the form below to register a profile to start receiving shifts with All Boats WA. Those marked with <strong>*</strong> are required fields and must be entered.</p>
            </div>
